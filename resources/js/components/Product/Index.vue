<template>
    <div
        ...
        class="product-card flex flex-col bg-card">
        <Link :href="route('products.show',product.slug)" class="product-card-photo overflow-hidden h-[600px] ">
            <img src="@assets\images\product\product-03.png" class="object-cover w-full h-full"
                 alt="Монитор LG 27 27GL650F-B">
        </Link>
        <div class="grow flex flex-col py-2 px-6">
            <h3 class="text-sm lg:text-md font-black">{{product.name}}<a href="#"
                                                         class="inline-block text-black hover:text-pink">T-shirt</a>
            </h3>
            <div class="mt-auto pt-6">
                <div class="mb-3 text-sm font-semibold">{{product.price}} ₽</div>
                <div class="flex flex-wrap items-center gap-4">
                    <button @click="addProductToCart(product.id)" href="#" class="w-[24px] !h-[24px] !px-0 btn btn-pink">
                    ...
                    <a href="#" class="w-[24px] !h-[24px] !px-0 btn btn-purple" title="В избранное">
